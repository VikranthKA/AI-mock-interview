  ...
  return (
    <div className='flex p-4 items-center justify-between bg-secondary shadow-sm'>
      ...
      <ul className='hidden md:flex gap-6 '>
        <li onClick={()=>router.push('/dashboard')} className={`hover:text-green-500 hover:font-bold transition cursor-pointer ${path==='/dashboard' && 'text-green-500 font-bold'}`} >Dashboard</li>
        <Link href='https://quickref.me/'>
        ...
        <li onClick={()=>router.push('/')} className={`hover:text-teal-500 hover:font-bold transition cursor-pointer ${path==='/works' && 'text-teal-500 font-bold'}`} >How it works?</li>
      </ul>
      <span className="pr-2">
